...
@interface ZXYPlaceListCell : UITableViewCell<ZXYEvaluateDatasource,ZXYEvaluateDelegate>

@property (nonatomic,strong)LocDetailInfo *locDetail;
@property (weak, nonatomic) IBOutlet UIImageView *headImage;

@property (weak, nonatomic) IBOutlet UILabel *titleLbl;
@property (weak, nonatomic) IBOutlet UIView *zxyEvaluate;
@property (nonatomic,strong) ZXYEvaluateView *zxyEvaluates;
